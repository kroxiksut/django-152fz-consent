...
Список правил аудитории — охват и требование согласия по цели/документу:

![Правила аудитории согласий](../../assets/consent/ru/13-consent-audience-rule.png)
...
Список записей с действием `Экспортировать выбранные записи в CSV`:

![Записи согласий в админке](../../assets/consent/ru/10-consent-records-admin.png)

Пример итоговой выгрузки:
...
Журнал операций с действием `Экспортировать выбранные записи журнала в CSV`:

![Журнал операций модуля согласий](../../assets/consent/ru/9-operation-audit-log.png)
...
Тот же экран с режимом списка `Pending only` и отозванным согласием:

![Отозванное согласие в списке согласий пользователя](../../assets/consent/ru/15-withdrawn-consent.png)
...
Политики уровня потока — режим проверки, охват и поведение для старых веб-согласий:

![Политики проверяемого согласия](../../assets/consent/ru/12-verified-consent-policy.png)
...
Переопределения на уровне форм по ключу `form_code`:

![Политики проверяемого согласия для форм](../../assets/consent/ru/11-verified-consent-form-policy.png)
...
Карточка отдельного артефакта — хэш документа, загруженный файл и действия `Verify as employee` / `Verify as administrator`:

![Артефакт проверяемого согласия](../../assets/consent/ru/14-verified-consent-artifact.png)
