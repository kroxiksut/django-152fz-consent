...
| [Модуль cookie](./cookies/ru/README.md) | [Модуль согласий](./consent/ru/README.md) |
| :---: | :---: |
| ![Cookie-баннер на сайте](./assets/cookie/ru/1-cookie-banner-on-site.png) | ![Форма записи на курс с блоком согласия](./assets/consent/ru/1-course-signup.png) |
...
- [Быстрый старт модуля согласий](./consent/ru/quickstart.md)
- [Быстрый старт модуля cookie](./cookies/ru/quickstart.md)
...
- [Коммерческая поддержка](./commercial-support.ru.md) — платное внедрение, адаптация и сопровождение для обоих пакетов
